<?php require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");?>
	...
	<h3>Калькулятор для расчета максимального целого количества дополнительных акций ОАО «РусГидро», которое может приобрести лицо в порядке осуществления им преимущественного права приобретения дополнительных акций ОАО «РусГидро»</h3>
	...
	<div style="font-size:0.9em; color:#333; text-align:justify;">Максимальное количество Акций, которое может приобрести лицо, имеющее преимущественное право приобретения размещаемых Акций</div>
	...
	<div class="clear"></div><?php require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");