...
if (!$APPLICATION->CaptchaCheckCode($_POST["captchaCode"], $_REQUEST["captchaId"])  && $_REQUEST["captcha_sid"]){
    echo "Не верно введена капча";
    die();
}
    ...
    if (
        ...
        if(isBlackOut()){
            ...
            if (count($arID) > 0 || isset($_COOKIE[$sessionKey])) {
                echo "Вы уже проголосовали"; exit;
            }
            ...
            if (
                ...
                echo "Спасибо!<br> Ваш голос учтен!"; exit;
            }
        }else{
