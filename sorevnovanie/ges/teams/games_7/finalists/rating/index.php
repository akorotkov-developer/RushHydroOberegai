...
<div class="tbl-stages-head"> 	
  <table width="100%"> 		<colgroup> 			<col width="398"></col> 			<col width="90"></col> 		</colgroup> 		
    <tbody>
      <tr> 			<td style="text-align: left; background: none; border-image: initial;">Название команды</td> 			<td style="border-image: initial;">Голосов</td> 			<td style="border-image: initial;">Рейтинг</td> 		</tr>
     	</tbody>
  </table>
...
?> <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PROPERTY_CODE" => array(0=>"VOTES_FINAL",1=>"",),
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
